          ...
          <div className="flex flex-row gap-2  xs:items-center xs:justify-between w-full">
            ...
            <div className="flex items-center gap-2 self-end xs:self-auto">
              ...
              <div className="flex gap-2">
                <button onClick={() => handleExport('csv')} className="flex gap-1.5 items-center cursor-pointer bg-slate-600 hover:bg-slate-700 text-white rounded-xl px-3 py-2 text-sm font-semibold transition-colors">
                  <DownloadIcon size={16} /> <span className="hidden sm:inline">CSV</span>
                </button>
                <button onClick={() => handleExport('xlsx')} className="flex gap-1.5 items-center cursor-pointer bg-green-600 hover:bg-green-700 text-white rounded-xl px-3 py-2 text-sm font-semibold transition-colors">
                  <DownloadIcon size={16} /> <span className="hidden sm:inline">Excel</span>
                </button>
              </div>
            </div>
          </div>
