...
const DetailModal = ({ selectedIndividu, setSelectedIndividu }) => {
  ...
  const ImageWithAuth = ({ path, alt, className, onClick }) => {
    ...
    if (failed) {
      return (
        <div className="h-48 sm:h-56 w-full bg-slate-100 flex flex-col items-center justify-center text-slate-400 border-2 border-dashed border-slate-200 rounded-xl">
    ...
    if (!objUrl)
      return (
        <div className="h-48 sm:h-56 w-full bg-slate-100 flex items-center justify-center text-slate-400 rounded-xl">
