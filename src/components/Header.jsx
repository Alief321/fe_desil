...
import { Map, Table as TableIcon, MapPin, Menu, X, LogOut } from 'lucide-react';

const Header = ({ view, setView, sidebarOpen, toggleSidebar, onLogout }) => {
  return (
    <header className="bg-white border-b px-6 py-3 flex justify-between items-center z-[1000] shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={onLogout} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors text-sm font-semibold">
