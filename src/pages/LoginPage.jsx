    ...
    <div className="relative min-h-screen flex items-center justify-center bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-[420px] px-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-blue-900 mb-2">VIVA DTSEN</h1>
          <p className="text-slate-500 font-medium tracking-wide">Data Sosial Ekonomi & Kemiskinan</p>
        </div>
        ...
        {/* Footer */}
        <p className="text-center text-slate-500 text-sm mt-8 font-medium">Bapperida / BPS &copy; {new Date().getFullYear()}</p>
      </div>
    </div>
  );
}
